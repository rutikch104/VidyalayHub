...
import { Users, GraduationCap, BarChart3, Search, Plus, Filter, MoreHorizontal, Eye, Edit, Trash2, Mail, Building, Settings, Download, CheckCircle, Clock, AlertCircle, Shield, PieChart, Activity, Loader2, Megaphone } from 'lucide-react';
...
const AdminDashboard = ({ portalAccess: portalAccessProp, onNavigate, onAccessDenied }) => {
    ...
    const tabs = useMemo(() => {
        ...
        if (isCollegeScoped)
            return all.filter((t) => t.id !== 'colleges');
        return all;
    }, [isCollegeScoped]);
