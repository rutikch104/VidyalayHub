...
export function mapPublicProfileToLayout(response) {
  ...
  return {
    ...
    academic_identity: response.academic_identity || null,
    professional_identity: response.professional_identity || null,
    degree: response.degree || undefined,
    branch: response.branch || undefined,
    academic_year: response.academic_year || response.student_year || undefined,
    graduation_batch: response.graduation_batch || undefined,
    teacher_department: response.teacher_department || undefined,
    ...
    academicInfo: {
      ...
      gpa: response.gpa,
      course: response.course || response.branch || undefined,
      department: response.department || response.degree || undefined,
      university: response.university || response.tenant_name || undefined,
      graduationYear: response.graduation_year,
      studentYear: response.academic_year || response.student_year,
    },
    professionalInfo: {
