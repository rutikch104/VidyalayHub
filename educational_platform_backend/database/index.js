...
db.UserRegistrationDocument = require('./models/user_registration_document')(sequelize, DataTypes);
...
db.PostRepost = require('./models/post_repost')(sequelize, DataTypes);
...
db.JobSkill = require('./models/job_skill')(sequelize, DataTypes);
